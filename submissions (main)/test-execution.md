...
| TC-41 | REQ-06 — Overdue Handling | Show no overdue records | BR003 of MEM006 show status "Quá hạn" | Fail | Screenshot/TC-41.png | BUG-13 |
| TC-42 | REQ-06 — Overdue Handling | BR001 is marked "Quá hạn" |  | Pass |  |  |
| TC-43 | REQ-06 — Overdue Handling | The record is marked "Quá hạn" (SRS: <= currentDate) | System:  convert status into “Đang mượn: 0 sách” when book isn't returned | Fail | Screenshot/TC-43.png | BUG-14 |
...
| REQ-06 — Overdue Handling | 8 | 6 | 2 | 75% |
| REQ-07 — Member Management | 8 | 4 | 4 | 50% |
